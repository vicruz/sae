...
<div class="page-content">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div>
				<input type="hidden" name="id" id="id" value='<c:out value="${alumno.id}" />'/>
				...
				<div class="col-md-6">
					<spring:bind path="idPagoGrado">
						<div class="form-group">
							...
							<form:select id="selectConcepto" path="idPagoGrado" class="form-control" onchange="cambiaMonto(value)">
